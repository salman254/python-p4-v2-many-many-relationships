...
# Association Table for many-to-many: Employee <-> Meeting
...
class Employee(db.Model):
    ...
    projects = association_proxy('assignments', 'project', creator=lambda proj: Assignment(project=proj))
...
class Project(db.Model):
    ...
    employees = association_proxy('assignments', 'employee', creator=lambda emp: Assignment(employee=emp))
